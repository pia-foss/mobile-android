object Android {
    ...
    const val swipeRefresh = "com.google.accompanist:accompanist-swiperefresh:0.30.1"
...
object Compose {
    const val COMPOSE_VERSION: String = "1.4.3"
...
object Koin {
    const val core = "io.insert-koin:koin-core:3.4.3"
    const val android = "io.insert-koin:koin-android:3.4.3"
    const val compose = "io.insert-koin:koin-androidx-compose:3.4.6"
    const val navigation = "io.insert-koin:koin-androidx-navigation:3.4.6"
}
...
object Kotlin {
    ...
    const val serializationCore = "org.jetbrains.kotlinx:kotlinx-serialization-core:1.5.1"
...
object UnitTest {
    ...
    const val koinTestJunit5 = "io.insert-koin:koin-test-junit5:3.4.1"
    const val koinTest = "io.insert-koin:koin-android-test:3.4.3"
    const val jUnit5Api = "org.junit.jupiter:junit-jupiter-api:5.10.0"
    ...
    const val androidCoreArch = "androidx.arch.core:core-testing:2.2.0"
}
...
object AndroidTest {
    ...
    const val mockk = "io.mockk:mockk-android:1.13.5"
    const val koinTest = "io.insert-koin:koin-test:3.4.3"
    const val androidCore = "androidx.test:core-ktx:1.5.0"
