...
class BuildConfigProvider(
    ...
    fun isMetaFlavor() = flavor == BuildFlavor.META

    fun isDebugType() = type == BuildType.DEBUG

    fun isReleaseType() = type == BuildType.RELEASE
}