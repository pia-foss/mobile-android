...
class DefaultLogoutHandlerTest {
    ...
    private lateinit var handler: DefaultLogoutHandler
    ...
    @Test
    fun `test clearLocalStorage preserves the consent decision but clears the analytics opt-in`() =
        runTest {
