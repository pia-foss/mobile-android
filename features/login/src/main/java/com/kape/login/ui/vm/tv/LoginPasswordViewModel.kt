...
class LoginPasswordViewModel(
    ...
    fun isValidPassword(): Boolean = password.value.isNotEmpty()

    fun getPassword(): MutableState<String> = password

    fun getLoginUsername(): String = loginUsernameUseCase.getLoginUsername()
}