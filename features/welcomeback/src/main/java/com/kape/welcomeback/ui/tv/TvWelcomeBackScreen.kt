package com.kape.welcomeback.ui.tv
...
import com.kape.welcomeback.ui.getErrorMessage
...
private fun TvWelcomeBackScreenContent(
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            Image(
                painter = painterResource(id = com.kape.welcomeback.R.drawable.tv_welcome_back_hero),
                contentDescription = null,
            )
        }
    }
